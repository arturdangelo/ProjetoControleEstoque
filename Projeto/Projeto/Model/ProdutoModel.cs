...
namespace Projeto.Model
{
    public class ProdutoModel
    {
        ...
        public void ProdutoSelecionado(int CodSelecionado, int num, DataGridView Dgv_ExibeProduto, TextBox Txt_Codigo, Label Lbn_Resultado)
        {
            ...
            try
            {
                ...
                using (SqlCommand sqlCommand = new SqlCommand(query, new SqlConnection(conexao.connectionString)))
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        //MessageBox.Show("1");
                        ProdutoController produto = new ProdutoController(codigoProduto, nomeProduto, precoProduto, qtdProduto, situacaoProd, Dgv_ExibeProduto, num, Txt_Codigo, Lbn_Resultado);
